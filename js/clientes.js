...
function loadClients() {
    try {
        ...
        const demoAddressFallback = {
            "demo-1": "Rua das Flores, 120",
            "demo-2": "Avenida Central, 845",
            "demo-3": "Rua das Acácias, 310",
            "demo-4": "Rua São João, 76",
            "demo-5": "Avenida Paulista, 1500"
        };
...
function saveClients(clientList = clients) {
    try {
        ...
        console.error("Não foi possível salvar os clientes temporários:", error);
        showToast("Não foi possível salvar os dados desta sessão.");
    }
}
...
function addClient(clientData) {
    ...
    showToast("Cliente cadastrado temporariamente.");
}
...
function deleteClient(clientId) {
    ...
    renderClients();
    showToast("Cliente removido da demonstração.");
}
